...
>
        ...
        <nav className="flex flex-col gap-1">
          ...
          >
            ...
            {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300">{t("navigation.sidebar.dashboard")}</span>}
          </NavLink>
          ...
          >
            <span className="text-xl shrink-0">🧾</span>
            {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300">{t("navigation.sidebar.sales")}</span>}
          </NavLink>
          ...
          >
            <span className="text-xl shrink-0">📦</span>
            {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300">{t("navigation.sidebar.products")}</span>}
          </NavLink>
          ...
          >
            <span className="text-xl shrink-0">👥</span>
            {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300">{t("navigation.sidebar.customers")}</span>}
          </NavLink>
          ...
          >
            <span className="text-xl shrink-0">📊</span>
            {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300">{t("navigation.sidebar.stock")}</span>}
          </NavLink>
          ...
          {(user?.role === "admin" || user?.role === "superadmin" ) && (
            <>
              ...
              >
                <span className="text-xl shrink-0">👤</span>
                {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300">{t("navigation.sidebar.users")}</span>}
              </NavLink>
              ...
              >
                <span className="text-xl shrink-0">🔐</span>
                {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300"> {t("navigation.sidebar.roles")}</span>}
              </NavLink>
              ...
              >
                <span className="text-xl shrink-0">📋</span>
                {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300">{t("navigation.sidebar.audit")}</span>}
              </NavLink>
              ...
              >
                <span className="text-xl shrink-0">📈</span>
                {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300">{t("navigation.sidebar.reports")}</span>}
              </NavLink>
              ...
              >
                <span className="text-xl shrink-0">💳</span>
                {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300"> {t("navigation.sidebar.subscription")}</span>}
              </NavLink>
            </>
          )}
          ...
          >
            ...
            {isOpen && <span className="font-black text-sm text-white whitespace-nowrap animate-in fade-in duration-300">{t("navigation.sidebar.logout")}</span>}
          </button>
        </nav>
        </div>
      </aside>
